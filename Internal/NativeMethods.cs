...
namespace Pdfium.NET.Internal
{
    public static partial class NativeMethods
    {
        ...
        {
            if (LoadNativeLibrary(AppDomain.CurrentDomain.RelativeSearchPath) is false)
                LoadNativeLibrary(Path.GetDirectoryName(typeof(NativeMethods).Assembly.Location));
        }
